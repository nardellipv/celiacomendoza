                    ...
                    @foreach($recipes as $recipe)
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <div class="restrurent-grid-columns only-hover">
                                <figure>
                                    <img src="{{ asset('images/thumbnail/recetas/'.$recipe->photos) }}" class="img-responsive" alt="{{ $recipe->name }}">
                                </figure>
                                <div class="caption-food-blog">
                                    <span><i class="fa fa-user" aria-hidden="true"></i>{{ $recipe->user->name }}</span>
                                    <span><i class="fa fa-calendar-plus-o" aria-hidden="true"></i>{{ Date::parse($recipe->created_at)->ago() }}</span>
                                ...
                                <div class="bottom-blog-caption">
                                    ...
                                    <a href="{{ url('recetas', $recipe->slug) }}" class="readmore-bt">Ver Receta...<i class="fa fa-angle-right"
