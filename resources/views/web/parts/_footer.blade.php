            ...
            <div class="row">
                ...
                <div class="col-xs-12  col-sm-12  col-md-4">
                    <div class="footer-widget-content">
                        <p class="mb-0">Queremos poder ofrecerle a los usuario una guía practica y simple para poder comparar precios y buscar locales cercanos
                        a sus domicilios como también dar la posibilidad a los distintos comercios y productores particulares de darse a conocer, llegar a mucha
...
{{--                            <div class="col-xs-12  col-sm-12  col-md-6 mb-30-xs mb-30-sm">
                ...
                <div class="col-xs-12  col-sm-12  col-md-8 widget-contact p-none-xs p-none-sm">
                    <form id="contact-form" action="assets/php/sendmail.php" method="post" novalidate="novalidate">
                        <div class="col-md-6">
                            <input type="text" class="form-control mb-30" name="contact-name" id="name" placeholder="Nombre :" required="" aria-required="true">
                        </div>
                        <div class="col-md-6">
                            <input type="email" class="form-control mb-30" name="contact-email" id="email" placeholder="Email :" required="" aria-required="true">
                        </div>
                        <div class="col-md-12">
                            <textarea class="form-control mb-30" name="contact-message" id="message" rows="4" placeholder="Mensaje" required="" aria-required="true"></textarea>
                        </div>
                        <div class="col-md-12">
                            <button type="submit" id="submit-message" class="btn btn-primary btn-block">Enviar mensaje</button>
                        </div>
                ...
                <div class="col-xs-12  col-sm-12  col-md-12">
                    ...
                    <div class="copyright pull-right pull-none-xs">
                        <p class="text-capitalize">
                            <a href="privacy.html">Política de Privacidad</a> – <a href="terms.html">Términos y condiciones</a>
                        </p>
                    </div>
                </div>
            </div>
