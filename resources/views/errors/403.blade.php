...
<html lang="es">
<head>
    <title>CeliacosMendoza | 403</title>
    ...
    <!-- /font files -->
    <!-- css files -->
    <link href="{{ asset('webStyle/error/css/style.css') }}" rel="stylesheet" type="text/css" media="all" />
    <!-- /css files -->
<body>
<div class="w3layouts-bg">
    ...
    <div class="w3layouts-right">
        <div class="w3ls-text">
            <h3>Lo sentimos!</h3>
            <h4 class="w3-agileits2">No tienes acceso a esta parte del sitio</h4>
            <p>Volver al <a href="{{ url('/') }}">inicio</a> si deseas puedes escribirnos a<a href="mailto:info@celiacosmendoza.com"> info@celiacosmendoza.com</a></p>
        </div>
    </div>
