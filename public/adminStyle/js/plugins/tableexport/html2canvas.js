...
(function() {
  //TD: support all possible length values
...
_html2canvas.Util.Bounds = function (element) {
  ...
  if (element.getBoundingClientRect){
    ...
    //TD add scroll position to bounds, so no scrolling of window necessary
...
//TD ideally, we'd want everything to go through this function instead of Util.Bounds,
...
(function(){
  ...
  /*
 * TD: Add IE10 vendor prefix (-ms) support
 * TD: Add W3C gradient (linear-gradient) support
 * TD: Add old Webkit -webkit-gradient(radial, ...) support
 * TD: Maybe some RegExp optimizations are possible ;o)
 */
    ...
    if(m1) {
      switch(m1[1]) {
        ...
        case '-webkit-gradient':
          ...
          gradient = {
            type: m1[2] === 'radial' ? 'circle' : m1[2], //TD: Add radial gradient support for older mozilla definitions
            x0: 0,
            y0: 0,
            x1: 0,
            y1: 0,
        ...
        case '-o-radial-gradient':
          ...
          if(m2 && m3){
            ...
            //TD: add support for "30px 40px" sizes (webkit only)
            }
          }
  ...
  Generate.Gradient = function(src, bounds) {
    ...
    //TD: add support for multi defined background gradients
...
_html2canvas.Parse = function (images, options, cb) {
  ...
  function setTextVariables(ctx, el, text_decoration, color) {
    ...
    if (shadows.length) {
      //TD: support multiple text shadows
  ...
  function renderTextDecoration(ctx, text_decoration, bounds, metrics, color) {
    switch(text_decoration) {
      case "underline":
        ...
        //TD As some browsers display the line as more than 1px if the font-size is big, need to take that into account both in position and size
      ...
      case "overline":
        ...
        break;
      case "line-through":
        //TD try and find exact position for line-through
  ...
  function renderBackgroundImage(element, bounds, ctx) {
    ...
    while(imageIndex--) {
      ...
      //TD add support for background-origin
      if (image) {
  ...
  function createStack(element, parentStack, bounds, transform) {
    ...
    //TD correct overflow for absolute content residing under a static position
  ...
  function renderElement(element, parentStack, ignoreBackground) {
    ...
    switch(element.nodeName){
      case "IMG":
        ...
        break;
      case "INPUT":
        //TD add all relevant type's, i.e. HTML5 new stuff
        // TD add support for placeholder attribute for browsers which support it
...
_html2canvas.Preload = function( options ) {
  ...
  //TD modify proxy to serve images with CORS enabled, where available
